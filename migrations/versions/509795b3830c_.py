...
Revision ID: 509795b3830c
Revises: 
Create Date: 2018-07-11 16:28:27.816077
...
def upgrade():
    ...
    op.create_index(op.f('ix_saving_account_account_currency'), 'saving_account', ['account_currency'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_saving_account_account_currency'), table_name='saving_account')
